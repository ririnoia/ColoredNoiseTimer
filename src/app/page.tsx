...
export default function Home() {
  const [noiseType, setNoiseType] = useLocalStorage<NoiseType>('noiseType', DEFAULT_NOISE)
  const [volume, setVolume] = useLocalStorage<number>('volume', DEFAULT_VOLUME)
  const [focusMinutes, setFocusMinutes] = useLocalStorage<number>('focusMinutes', DEFAULT_FOCUS_MINUTES)
  const [breakMinutes, setBreakMinutes] = useLocalStorage<number>('breakMinutes', DEFAULT_BREAK_MINUTES)
  const [endSoundEnabled, setEndSoundEnabled] = useLocalStorage<boolean>('endSoundEnabled', DEFAULT_END_SOUND_ENABLED)
